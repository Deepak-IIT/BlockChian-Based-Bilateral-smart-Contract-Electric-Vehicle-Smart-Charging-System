...
contract Aggregator {
    ...
    function registerProfile(string memory make, string memory model, uint8 batterySize) external {
    ...
    function getProfile() external view returns (EvInfo memory profile) {
    ...
    function getMyEnergyRequirements() external view returns (EnergyRequirement[] memory) {
    ...
    function getEnergyRequirementsForNextSchedule() external view returns (EnergyRequirement[] memory) {
    ...
    function storeSchedule(Schedule[] memory newSchedules) public onlyOwner {
        // Empty old schedules
        ...
        // Add new schedules
        for (uint i = 0; i < newSchedules.length; i++) {
    ...
    function retrieveMyCurrentSchedule() external view returns (Schedule memory schedule) {
